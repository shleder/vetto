class Vetto < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/shleder/vetto/releases/download/v0.2.24/vetto-macos-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shleder/vetto/releases/download/v0.2.24/vetto-linux-aarch64.tar.gz"
      sha256 "c2f0814cc22e030261a719ff248d5949a50a75ffbf727f8db748df028c1fa2b4"
    else
      url "https://github.com/shleder/vetto/releases/download/v0.2.24/vetto-linux-x86_64.tar.gz"
