class Vetto < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shleder/vetto/releases/download/v0.2.12/vetto-macos-aarch64.tar.gz"
      sha256 "9710e5b94bc2c28e7a644a875189f58f3b01b157e0bc620025de62a4ef8a8b1f"
    else
      url "https://github.com/shleder/vetto/releases/download/v0.2.12/vetto-macos-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shleder/vetto/releases/download/v0.2.12/vetto-linux-aarch64.tar.gz"
      sha256 "f7c9fcde23c0fd6983ef2dde511b88053b0c03e817e66bf5c886f0f0e3f3bc63"
    else
      url "https://github.com/shleder/vetto/releases/download/v0.2.12/vetto-linux-x86_64.tar.gz"
