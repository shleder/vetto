class Vetto < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shleder/vetto/releases/download/v0.3.8/vetto-macos-aarch64.tar.gz"
      sha256 "44be7f5a852cb70a1fa6165b10ba9741ee992b90fe2bd7be924eb4e26885c937"
    else
      url "https://github.com/shleder/vetto/releases/download/v0.3.8/vetto-macos-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shleder/vetto/releases/download/v0.3.8/vetto-linux-aarch64.tar.gz"
      sha256 "fa545eecdd2b84d7bd6b8ef3665cfe699fe5a1b0450877aa450bec397d8300cf"
    else
      url "https://github.com/shleder/vetto/releases/download/v0.3.8/vetto-linux-x86_64.tar.gz"
