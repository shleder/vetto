...
For release `v0.2.24`, pre-generated CycloneDX 1.5 SBOM artifacts are published directly on [GitHub Releases](https://github.com/shleder/vetto/releases/tag/v0.2.24).
